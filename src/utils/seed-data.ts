import { databases, account, DATABASE_ID, EMPRESAS_COLLECTION_ID, EMPLEADOS_COLLECTION_ID, CITAS_COLLECTION_ID, CLIENTES_COLLECTION_ID, ARTICULOS_COLLECTION_ID, USUARIO_EMPRESAS_COLLECTION_ID, CONFIGURATION_COLLECTION_ID } from '@/lib/appwrite';
...
export async function seedData() {
    try {
        ...
        return { success: true, message: 'Datos generados correctamente' };
